    ...
    <div class="w1000">
        <div class="item info">
            ...
            <div class="cont">
                ...
                <div class="per-info">
                    <p>
                        <span class="name" style="color:orangered;font-weight: 700;">${loginUser.username}</span><br/>
                        <span class="age" style="color: orangered;font-weight:700;">${loginUser.startTime}</span><br/>
                    </p>
                </div>
            </div>
        </div>
