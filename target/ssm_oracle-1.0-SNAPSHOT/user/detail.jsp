                ...
                <div class="review-version">
                    <div class="form-box">
                        <div class="article-cont">
                            <div class="title">
                                ...
                                <p class="cont-info"><span class="data">${article.articleTime}</span></p>
                            </div>
                            <%--<p>爷每天5点起床，去鸡行里选鸡，选的是大小均匀的老母鸡，送到家里从杀鸡放血开始，--%>
                                <%--鸡血要留着，倒在有盐水的碗里，烧好开水拔了毛连鸡嘴巴鼻子里的粘液都要挤出来--%>
                                <%--。鸡洗干净六只鸡放到一个锅里炖，要炖一个上午，要注意火候鸡皮不能裂。</p>--%>
                            <img src="${pageContext.request.contextPath}/${article.articleImg}" width="1000" height="529">
                        ...
                        <div >
                            ...
                            <form  action="${pageContext.request.contextPath}/comment/addComment?articleId=${article.articleId}" method="post">
                                ...
                                        <input name="commentForArticle" value="${article.articleId}" hidden="hidden"/>
                                <c:if test="${!empty loginUser}">
                    ...
                    <div class="list-cont">
                        <c:forEach items="${commentList}" var="comment">
                            <c:if test="${comment.commentForArticle==article.articleId}">
                            <div class="cont">
                                <div class="img">
